        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="Only questions with their status set to 'Active' will be displayed. Questions marked as 'Group Header' are treated as such by views and templates that are set up to use them.",
                        choices=[(1, "Active"), (0, "Inactive"), (2, "Group Header")],
                        verbose_name="status",
                    ),
                ),
                (
